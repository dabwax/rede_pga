...
<a href="javascript:;" class="link-card" data-id="{{lesson.id}}" modal>
	...
	<div class="card-content">
			...
			<span href="<?php echo $this->Url->build('/feed/') ?>?hashtag_id={{entries.hashtag.id}}" class="chip chip-hashtag grey lighten-3" ng-repeat="(id, entries) in lesson.lesson_hashtags">
